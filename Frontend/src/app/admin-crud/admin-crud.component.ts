...
export class ProductTableComponent implements OnInit {
  products: Product[] = [];
  apiUrl = 'http://localhost:5292/api/Product/getallproducts'; // API endpoint for fetching products
  deleteUrl = 'http://localhost:5292/api/Product/deleteproductbyid'; // Change to HTTPS as well
